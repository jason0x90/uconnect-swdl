...
-- Generated Thu Sep 26 15:00:22 2013
...
local manifest =
{
    ...
    parts = { units.system_check, units.ioc_bootloader, units.ioc, units.ifs, units.mmc_ifs, units.speech_service, units.eq, units.skins, units.xlets, units.sierra_air_card, units.xm_update }
}
return manifest